              ...
              <tbody>
                @foreach($cars as $cars)
                  <tr>
                      ...
                      <td><a href="{{ route('cars.edit',$cars->id) }}"><span class="glyphicon glyphicon-edit"></span></a></td>
                      <td>
                          <form method="post"id="delete-form-{{ $cars->id }}" action="{{ route('cars.destroy',$cars->id) }}" style="dispaly: none">
                              {{ csrf_field()}}
                              {{ method_field('DELETE') }}
                          </form>
                          <a href="" onclick=" 
                              ...
                              {
                                  event.preventDefault();document.getElementById('delete-form-{{ $cars->id }}').submit();
                              }
                              else
                              {
