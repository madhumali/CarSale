...
class CarsController extends Controller
{
    ...
    {
        $cars = cars::all();
        return view('manager.cars.show',compact('cars'));
    }
    ...
    public function create()
    {
        ...
        return view('manager.cars.create',compact('tags','categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $tags = tags::all();
        $categories = categories::all();
        return view('manager.cars.edit',compact('tags','categories','cars'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('image'))
        {
            ...
            Storage::delete('images/cars/front/'.$oldFilename2);
        }
